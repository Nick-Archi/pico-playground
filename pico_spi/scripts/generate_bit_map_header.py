...
def generate_bitmap_file(**kwargs):
    ...
    header_info = ["/*", "* Autogenerated bitmap file from {}\n".format(filename), "*/", "\n"] 
    header_info.append("#ifndef _{}_BITMAP_H_".format(filename.upper()))
    header_info.append("#define _{}_BITMAP_H_".format(filename.upper()))

    trailer_info = ["#endif // _{}_BITMAP_H_".format(filename.upper())]

    # compose the body of the file now...
    body_info = ["static const uint8_t {}_bitmap[][8] = ".format(filename.lower()), "{"]
...
if __name__ == "__main__":
    ...
    generate_bitmap_file(filename="test",bitmappings=bit_list)
